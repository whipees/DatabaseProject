...
class PEP249ModuleTests(PEP249Base):
    ...
    def test_connect(self):
        ...
        self.assertTrue(
            inspect.isfunction(myconn.connect),
        ...
        if tests.MYSQL_CAPI:
            ...
            self.assertTrue(
                isinstance(cnx, myconn.connection_cext.CMySQLConnection),
    ...
    def test_paramstyle(self):
        ...
        self.assertEqual(
            "pyformat", myconn.paramstyle, "paramstyle should be 'pyformat'"
        )
...
class PEP249ErrorsTests(PEP249Base):
    ...
    def test_Warning(self):
        ...
        self.assertTrue(
            issubclass(myconn.errors.Warning, Exception),
    ...
    def test_Error(self):
        ...
        self.assertTrue(
            issubclass(myconn.errors.Error, Exception),
    ...
    def test_InterfaceError(self):
        ...
        self.assertTrue(
            issubclass(myconn.errors.InterfaceError, myconn.errors.Error),
    ...
    def test_DatabaseError(self):
        ...
        self.assertTrue(
            issubclass(myconn.errors.DatabaseError, myconn.errors.Error),
    ...
    def test_DataError(self):
        ...
        self.assertTrue(
            issubclass(myconn.errors.DataError, myconn.errors.DatabaseError),
...
class PEP249CursorTests(PEP249Base):
    ...
    def test_callproc(self):
        ...
        self.assertTrue(
            hasattr(self.cur, "callproc"),
            "Cursor object has no callproc()-method",
        )
        self.assertTrue(
            inspect.ismethod(self.cur.callproc),
    ...
    def test_close(self):
        ...
        self.assertTrue(
            hasattr(self.cur, "close"), "Cursor object has no close()-method"
        )
        self.assertTrue(
            inspect.ismethod(self.cur.close),
    ...
    def test_execute(self):
        ...
        self.assertTrue(
            hasattr(self.cur, "execute"),
            "Cursor object has no execute()-method",
        )
        self.assertTrue(
            inspect.ismethod(self.cur.execute),
    ...
    def test_nextset(self):
        ...
        self.assertTrue(
            hasattr(self.cur, "nextset"),
            "Cursor object has no nextset()-method",
        )
        self.assertTrue(
            inspect.ismethod(self.cur.nextset),
    ...
    def test_setinputsizes(self):
        ...
        self.assertTrue(
            hasattr(self.cur, "setinputsizes"),
            "Cursor object has no setinputsizes()-method",
        )
        self.assertTrue(
            inspect.ismethod(self.cur.setinputsizes),
    ...
    def test_setoutputsize(self):
        ...
        self.assertTrue(
            hasattr(self.cur, "setoutputsize"),
            "Cursor object has no setoutputsize()-method",
        )
        self.assertTrue(
            inspect.ismethod(self.cur.setoutputsize),
...
class PEP249TypeObjConstructorsTests(PEP249Base):
    ...
    def test_TimestampFromTicks(self):
        ...
        self.assertEqual(
            myconn.TimestampFromTicks(ticks),
            exp,
    ...
    def test_Binary(self):
        ...
        self.assertEqual(
            myconn.Binary(r"\u82b1".encode("utf-8")),
            exp,
